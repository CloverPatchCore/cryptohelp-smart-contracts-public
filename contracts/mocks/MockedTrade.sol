...
contract MockedTrade is Trade {
    constructor(address factoryV2, address routerContract) public Trade(factoryV2, routerContract) {
        return;
    }

    function increaseAgreementIncome(uint256 agreementId, uint256 amount)
        external
